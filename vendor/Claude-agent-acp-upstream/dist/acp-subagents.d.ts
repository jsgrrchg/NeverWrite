import type { ClientCapabilities, SessionCapabilities, SessionNotification } from "@agentclientprotocol/sdk";
...
export type AcpSessionUpdate = SessionNotification["update"] | SubagentSpawnedUpdate | SubagentStateUpdate | AsyncTaskSpawnedUpdate | AsyncTaskProgressUpdate | AsyncTaskStateUpdate;
...
export declare function clientSupportsSubagents(capabilities?: ClientCapabilities | null): boolean;
/** The only cast needed until the TypeScript SDK publishes PR #1992. */
export declare function asSdkSessionNotification(notification: AcpSessionNotification): SessionNotification;
