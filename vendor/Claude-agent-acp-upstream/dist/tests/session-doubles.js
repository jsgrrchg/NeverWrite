...
export function wrapQuery(generator) {
...
export function mockSessionState(overrides = {}, agent, sessionId = "test-session") {
    return {
        cancelled: false,
        cwd: "/test",
...
export function successfulResultMessage(overrides = {}) {
    return {
        type: "result",
        subtype: "success",
