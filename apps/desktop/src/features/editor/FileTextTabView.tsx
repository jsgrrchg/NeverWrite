...
export function FileTextTabView({ paneId }: FileTextTabViewProps) {
  ...
  const [editorContextMenu, setEditorContextMenu] = useState<ContextMenuState<{
  ...
  useEffect(() => {
    ...
    const nextView = new EditorView({
      state: EditorState.create({
        ...
        extensions: [
          baseTheme,
          wrappingCompartmentRef.current.of(getWrappingExtension(lineWrapping)),
          drawSelection(),
    ...
    nextView.dom.addEventListener("contextmenu", handleNativeContextMenu, true);
  ...
  }, [inlineReviewEnabled, tab, tabRef, trackedFileMatch?.trackedFile.version]);
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              style={{
                border:
                  "1px solid color-mix(in srgb, #f59e0b 45%, var(--border))",
      ...
      >
        <div className="min-w-0 truncate text-[11px]" title={tab.relativePath}>
          <span
