...
// Keep the provider mark shared between editor tabs and agent rows so a
// session has the same visual identity wherever it is opened.
    ...
    if (runtimeId.includes("claude")) {
        return (
            ...
            >
                ...
                />
                <path
                    d="M9.49897 0L0 24H5.31125L7.25395 18.96H17.1914L19.1341 24H24.4454L14.9464 0H9.49897ZM8.97193 14.5029L12.2227 6.06857L15.4735 14.5029H8.97193Z"
                    fill="currentColor"
                />
            </svg>
        );
