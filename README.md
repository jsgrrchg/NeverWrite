...
- An ACP-based AI layer with Codex, Claude, GitHub Copilot, Grok, Kilo, and OpenCode runtimes.
...
- GitHub Copilot is integrated in the app, but not bundled by default today.
