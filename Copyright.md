...
| --------------------------------------- | ------- | ------------------------------- |
| @agentclientprotocol/claude-agent-acp   | 0.81.2  | Apache-2.0                      |
...
| @agentclientprotocol/claude-agent-acp 0.81.2 | Apache-2.0 | github.com/agentclientprotocol/claude-agent-acp |
